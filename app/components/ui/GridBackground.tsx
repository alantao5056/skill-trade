...
export default function GridBackground({ className, children }: GridBackgroundProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full h-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[var(--color-background)]",
        className
      )}
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute right-[10%] top-[-10%] w-[20%] h-[20%] rounded-full bg-[var(--color-primary)]/30 blur-[100px]" />
    ...
    <svg className="w-full h-full">
      <defs>
        <motion.pattern
          ...
          x={offsetX as React.ComponentProps<typeof motion.pattern>["x"]}
          y={offsetY as React.ComponentProps<typeof motion.pattern>["y"]}
        >
          <path
            d="M 40 0 L 0 0 0 40"
            fill="none"
